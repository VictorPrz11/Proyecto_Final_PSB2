...
leersensor     : ID AS LEERSENSOR LPAREN expr RPAREN ;
moverservo     : MOVERSERVO LPAREN expr COMMA expr RPAREN ;
esperar        : ESPERAR LPAREN expr RPAREN ;
asignacion     : ID AS expr ;
condicion      : SI LPAREN expr comparador expr RPAREN ENTONCES (sentencia | LBRACE sentencia+ RBRACE) ;
